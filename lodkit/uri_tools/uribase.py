...
def URIConstructorMetaFactory(namespace: str) -> type:
...
def uribase(namespace: str | Namespace) -> type:
    ...
    class URIConstructor(metaclass=URIConstructorMetaFactory(namespace)):
        def __init__(self):
